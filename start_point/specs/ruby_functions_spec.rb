...
class FunctionsTest < MiniTest::Test
  ...
  def test_volume_of_cube_3()
    #add test code here
    cube_volume1 = cal_cube_volume(3)
    assert_equal(27,cube_volume1)
  end

  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere_3()
    #add test code here
    sphere_volume1 = cal_sphere_volume(3)
    assert_equal((4*Math::PI*3*3*3)/3,sphere_volume1)
  end
  ...
  def test_fahrenheit_to_celsius_32()
    ...
    celius = trans_temperature(32)
    assert_equal(0,celius)
  end
